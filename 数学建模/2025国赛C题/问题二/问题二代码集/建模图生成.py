...
print(f"{'假阴性率':<12} {fnr_raw:<10.4f} {fnr_adj:<10.4f} {((fnr_adj - fnr_raw) / fnr_raw * 100) if fnr_raw > 0 else 0:<10.2f}%")
print(f"{'假阳性率':<12} {fpr_raw_val:<10.4f} {fpr_adj_val:<10.4f} {((fpr_adj_val - fpr_raw_val) / fpr_raw_val * 100) if fpr_raw_val > 0 else 0:<10.2f}%")
print("-" * 70)
